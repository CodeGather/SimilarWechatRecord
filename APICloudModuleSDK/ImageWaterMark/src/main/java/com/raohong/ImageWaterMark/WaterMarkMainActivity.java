...
import com.raohong.ImageWaterMark.R;
import com.raohong.ImageWaterMark.RubberStamp;
import com.raohong.ImageWaterMark.RubberStampConfig;
import com.raohong.ImageWaterMark.RubberStampPosition;
...
public class WaterMarkMainActivity extends AppCompatActivity {
    ...
    public void init() {
        ...
        mBaseBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.lenna);
