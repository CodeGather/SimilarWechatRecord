...
public class TuyaViewActivity extends View {
    ...
    public TuyaViewActivity(Context context) {
        super(context);
        init();
    }

    public TuyaViewActivity(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TuyaViewActivity(Context context, AttributeSet attrs, int defStyleAttr) {
